...
export declare function defaultBubbleList(editor: Editor): BubbleMenuItem[];
/**
 ...
 */
export declare function generateBubbleTypeMenu<T = any>(list: NodeTypeMenu, defaultList: BubbleMenuItem[], { editor, extension, t }: ButtonViewParams<T>): BubbleTypeMenu;
export {};
